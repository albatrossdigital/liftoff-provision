...
###
include /data/disk/o1/config/server_master/nginx/post.d/nginx_force_include*;
<?php endif; ?>
###
...
###
include /data/disk/o1/config/server_master/nginx/post.d/nginx_vhost_include*;
<?php endif; ?>
<?php if ($nginx_config_mode == 'extended'): ?>
###
